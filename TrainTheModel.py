# -*- coding: utf-8 -*-
"""
Created on Sat Jan 19 10:38:52 2019

@author: Gareth
"""
# code based on : https://github.com/cfotache/pytorch_imageclassifier/blob/master/PyTorch_Image_Training.ipynb
...
for epoch in range(epochs):
    for inputs, labels in trainloader:
        ...
        if steps % print_every == 0:
            ...
            running_loss = 0
            model.train()
torch.save(model, 'aerialmodeln300.pth')
